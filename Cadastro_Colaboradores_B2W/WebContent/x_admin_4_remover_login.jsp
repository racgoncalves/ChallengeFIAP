...
<title>xcave Solution - Remover Login</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<!-- JS Local -->
		<script src="js/removerLogin.js"></script>
</body>
