...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Baixar Documento -->
			<li class="nav-item active my-4"><a id="botaoBaixarDoc"
				style="cursor: pointer" class="nav-link"><i
					style="font-size: 30px;" class="fas fa-download"></i><span
					style="font-size: 15px;">Baixar</span></a></li>

			<!-- Divider -->
			<hr class="sidebar-divider my-0">

			<!-- Atualizar Documento -->
			<li class="nav-item active my-4"><a id="botaoAtualizarDoc"
				style="cursor: pointer" class="nav-link"><i
					style="font-size: 30px;" class="fas fa-file-upload"></i><span
					style="font-size: 15px;">Alterar</span></a></li>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title ml-2 mt-2" id="exampleModalLabel">Documentos
										do colaborador</h5>

								</div>
								<div class="card-body">
									<!-- Baixar Zip com todos os documentos -->
									<div class="ml-1 mt-2">
										<label for="baixarZip">Baixar Todos</label>
										<button id="botaoBaixarZip" class="ml-2 btn btn-warning">
											<i class="fas fa-file-archive"></i>
										</button>
									</div>

									<!-- Formulário para reenviar ou baixar documento -->
									<form method="post" action="atualizarDocumento"
										id="form_documento">
										<div class="row mt-4" style="width: 400px;">
											<div class="col-12 mb-4 ml-1">
												<label for="nomeDocumento">Selecione o tipo de
													documento que deseja baixar ou alterar</label> <select
													class="form-control" id="nomeDocumento"
													name="nomeDocumento">
													<option value="0" disabled selected>Selecione</option>
													<option value="1">RG</option>
													<option value="2">CARTEIRA DE TRABALHO</option>
													<option value="3">COMPROVANTE DE RESIDÊNCIA</option>
													<option value="4">TÍTULO DE ELEITOR</option>
													<option value="5">COMPROVANTE DE ESCOLARIDADE</option>
													<option value="6">CERTIFICADO DE RESERVISTA</option>
												</select>
											</div>

											<div class="col-12 mt-3 ml-2">
												<label for="nomeArquivo">Adicione um arquivo para
													alterar o documento selecionado</label> <input type="file"
													class="form-control-file" id="nomeArquivo"
													name="nomeArquivo">
	...
	<!-- JS Local -->
	<script src="js/baixarZip.js"></script>
	<script src="js/baixarDoc.js"></script>
	<script src="js/atualizarDoc.js"></script>
