...
<title>xcave Solution - Remover Dependente</title>
...
<body id="page-top">
	...
	<div id="wrapper">
				...
				<div class="container-fluid">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<form method="post" action="removerDependente">
								<div class="modal-footer">
									<input style="visibility: hidden; width: 0;" type="text"
										value="<%=codigo%>" name="codigo" id="codigo"> <input
										style="visibility: hidden; width: 0;" type="text"
										value="<%=matricula%>" name="matricula" id="matricula">
									<button type="button" id="botaoRemoverDep"
		...
		<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">Selecione "sair" abaixo se você
		...
		<!-- JS Local -->
		<script src="js/removerDep.js"></script>
</body>
