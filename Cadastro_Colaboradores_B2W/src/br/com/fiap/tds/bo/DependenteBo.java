...
public class DependenteBo {
	...
	/**
	 * Valida os dados do dependente e aciona a camada de Dao para atualizá-lo
	 * 
	 * @param dep Objeto contendo o dependente
	 * @throws ClassNotFoundException
	 * @throws DadoInvalidoException
	 ...
	 * @throws ItemNaoEncontradoException
	 */
	public void atualizar(Dependente dep) throws ClassNotFoundException, DadoInvalidoException, SQLException,
			AtualizacaoNaoRealizadaException, ItemNaoEncontradoException, ItemCadastradoException {

		validarAtualizacao(dep);
		depDao.atualizar(dep);
	}

	/**
	 * Recupera os dados de um dependente
	 * 
	...
	public Dependente pesquisar(int matricula, int codigo)
		...
		return depDao.pesquisar(matricula, codigo);
	}
	...
	private void validar(Dependente dep) throws ClassNotFoundException, SQLException, ItemNaoEncontradoException,
		...
		if (depDao.isCpfCadastrado(dep.getCpf()))
			throw new DadoInvalidoException("\nCPF já cadastrado!");
	...
	/**
	 * Método que valida de acordo com as regras os dados de um dependente para
	 * atualizar
	 * 
	 * @param dep Objeto contendo o dependente
	 * @throws ClassNotFoundException
	 ...
	 * @throws DadoInvalidoException
	 */
	private void validarAtualizacao(Dependente dep)
		...
		if (!depDao.isMesmoCpf(dep.getCpf(), dep.getLogin().getMatricula(), dep.getCodigo())) {
			if (depDao.isCpfCadastrado(dep.getCpf()))
				throw new DadoInvalidoException("\nCPF já cadastrado!");
		}
